...
class DashboardSummary {
  ...
  factory DashboardSummary.fromJson(Map<String, dynamic> j) => DashboardSummary(
        ...
        monthlyExpense: (j['monthly_expense'] as num).toDouble(),
        monthlyBalance: (j['monthly_balance'] as num).toDouble(),
        recentTransactions:
            (j['recent_transactions'] as List).map((e) => Transaction.fromJson(e)).toList(),
        monthlyChart: (j['monthly_chart'] as List).map((e) => MonthlySummary.fromJson(e)).toList(),
        expenseByCategory:
